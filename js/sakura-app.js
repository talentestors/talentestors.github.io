  ...
  switch (type) {
    case 1:
      if (ele.src.includes('https://cn.gravatar.com/avatar')) {
        ele.src = ele.src.replace('https://cn.gravatar.com/avatar/', 'https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/other/gravatar.jpg')
      } else {
        ele.src = 'https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/other/default_avatar.jpg'
      }
      break
    case 2:
      ele.src = 'https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/other/default_gavatar.jpg'
      break
    case 3:

      ele.src = 'https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/other/image-404.png'
      break
    default:
      ele.src = 'https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/other/image-404.png'
  }
    ...
    for (var i = 0; i < this.files.length; i++) {
      ...
      $.ajax({
        ...
        beforeSend: function (xhr) {
          ...
          $('#upload-img-show').append('<img class="lazyload upload-image-preview" src="https://jsdelivr.codeqihan.com/gh/moezx/cdn@3.0.2/img/svg/loader/trans.ajax-spinner-preloader.svg" data-src="' + get_the_url + '" onclick="window.open(\'' + get_the_url + '\')" onerror="imgError(this)" />')
          lazyload()
...
function checkBgImgCookie () {
  ...
  if (bgurl != '') {
    if (bgurl == 'https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/themebg/sakura.png' || bgurl == 'https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/themebg/plaid.jpg' || bgurl == 'https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/themebg/star.png' || bgurl == 'https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/themebg/point.png' || bgurl == 'https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/themebg/little-monster.png') {
...
$(document).ready(function () {
  ...
  changeBG('#sakura-bg', 'https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/themebg/sakura.png')
  changeBG('#gribs-bg', 'https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/themebg/plaid.jpg')
  changeBG('#pixiv-bg', 'https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/themebg/star.png')
  changeBG('#KAdots-bg', 'https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/themebg/point.png')
  changeBG('#totem-bg', 'https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/themebg/little-monster.png')
  ...
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true
    mashiro_global.variables.isNight = true
    $('body').css('background-image', 'url(https://jsdelivr.codeqihan.com/gh/talentestors/cdn/img/other/starry_sky.png)')
...
//             bot_ui_ini();
//         } else {
//             $.getScript('https://jsdelivr.codeqihan.com/gh/moezx/cdn@latest/js/botui/botui.js', function () {
//                 bot_ui_ini();
...
//         loadCSS("https://jsdelivr.codeqihan.com/gh/moezx/cdn@3.1.8/css/cn.css");
//         currentFontIsUbuntu = false;
//     } else {
//         loadCSS("https://jsdelivr.codeqihan.com/gh/moezx/cdn@3.1.8/css/or.css");
...
//         loadCSS("https://jsdelivr.codeqihan.com/gh/moezx/cdn@3.1.8/css/tw.css");
//     }
//     if (zh == 'tw') {
...
$(function () {
  ...
  console.log('%c stazxr %c', 'background:#24272A; color:#ffffff', '', 'https://www.stazxr.cn/')
...
// loadCSS("https://jsdelivr.codeqihan.com/gh/moezx/cdn@3.5.4/fonts/Moe-Mashiro/stylesheet.css");
// loadCSS("https://fonts.googleapis.com/css?family=Noto+SerifMerriweather|Merriweather+Sans|Source+Code+Pro|Ubuntu:400,700");
// loadCSS("https://jsdelivr.codeqihan.com/gh/moezx/cdn@3.3.9/css/sharejs.css");;
